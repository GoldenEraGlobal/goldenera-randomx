# Welcome to goldenera-randomx
(this is a fork of [xdagj-native-randomx](https://github.com/XDagger/xdagj-native-randomx))

![Latest Release](https://img.shields.io/github/v/release/GoldenEraGlobal/goldenera-randomx)
![License](https://img.shields.io/github/license/GoldenEraGlobal/goldenera-randomx)
![Issues](https://img.shields.io/github/issues/GoldenEraGlobal/goldenera-randomx)
---
...
```bash
git clone https://github.com/GoldenEraGlobal/goldenera-randomx.git
...
cd RandomX
mkdir build && cd build
cmake .. -G "MinGW Makefiles" -DCMAKE_BUILD_TYPE=Release -DARCH=native -DBUILD_SHARED_LIBS=ON -DCMAKE_SHARED_LINKER_FLAGS="-static-libgcc -static-libstdc++" -DCMAKE_EXE_LINKER_FLAGS="-static-libgcc -static-libstdc++"
make -j4
...
- [xdagj-native-randomx](https://github.com/XDagger/xdagj-native-randomx) (original implementation)
